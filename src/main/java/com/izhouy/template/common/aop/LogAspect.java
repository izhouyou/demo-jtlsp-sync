...
import com.izhouy.template.common.observer.LogEventPublisher;
...
public class LogAspect {
    ...
    public void doAfterReturning(JoinPoint joinPoint, Object keys) {
        ...
        try {
            ...
            // 发布消息
            logEventPublisher.pushListener(logInfo);
    ...
    public void doAfterThrowing(JoinPoint joinPoint, Throwable e) {
        ...
        try {
            ...
            LogErrorInfo logErrorInfo = LogErrorInfo.builder()
                    ...
                    .createTime(new Date())
                    .build();
            logEventPublisher.pushErrorLogEvent(logErrorInfo);
//            logErrorInfoService.save(logErrorInfo);
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    }
